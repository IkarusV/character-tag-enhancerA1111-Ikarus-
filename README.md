...
4. ***Very important*** Move/put **character_supplements.json** into your root *stable diffusion webui forge folder*, ***if not it won't be detected***.
...
1. Edit `character_supplements.json` in the root stable diffusion folder(*or extension if you did not move it yet*).
